		...
		<form action="cadastrar_aluguel_de_carro" method="post">
			...
			<table>
				<tr>
					...
					<td><input type="text" maxlength="8" id="carro_placa"
						name="carro_placa"
						value='<c:out value="${aluguelDeCarro.carro.placa}"/>'></td>

					<td><button type="submit" name="botao"
							value="PesquisarCarroPlaca">Pesquisar</button></td>
					<!--PesquisarCarroPlaca-->
				</tr>
				...
				<tr>
					...
					<td><input type="text" maxlength="11" id="locatario_cpf"
						name="locatario_cpf"
						value='<c:out value="${aluguelDeCarro.locatario.cpf}"/>'></td>
				</tr>

				<tr>
					<td><Label for="data_retirada">Dia de retirada:</Label></td>

					<td><input type="date" id="data_retirada" name="data_retirada"
						value='<c:out value="${aluguelDeCarro.dataRetirada}"/>'></td>
				</tr>

				<tr>
					<td><Label for="data_devolucao">Dia de devolução:</Label></td>

					<td><input type="date" id="data_devolucao"
						name="data_devolucao"
						value='<c:out value="${aluguelDeCarro.dataDevolucao}"/>'></td>
				</tr>
					...
					<c:forEach var="carro" items="${carros}">
						...
						<tr>
							...
							<td colspan="4"><a class="a_link_clicavel"
								href="${pageContext.request.contextPath }/cadastrar_aluguel_de_carro?acao=selecionar&id=${carro.placa}">Selecionar</a>
							</td>
							<!-- selecionar -->
						</tr>
						<tr>
