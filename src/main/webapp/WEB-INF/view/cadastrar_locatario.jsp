        ...
        <form action="cadastrar_locatario" method="post">
            ...
            <table>
                <tr>
                    ...
                    <td><input type="text" id="cpf" name="cpf" maxlength="11" value='<c:out value="${locatario.cpf}"/>'></td>
                </tr>

                <tr>
                    <td><Label for="nome">Nome do locatario:</Label></td>
                    <td><input type="text" id="nome" name="nome" maxlength="90" value='<c:out value="${locatario.nome}"/>'></td>
                </tr>

                <tr>
                    <td><Label for="num_habilitacao">Núm. Habilitacao do locatario:</Label></td>
                    <td><input type="text" id="num_habilitacao" name="num_habilitacao" maxlength="11" value='<c:out value="${locatario.numHabilitacao}"/>'></td>
                </tr>

                <tr>
                    <td><Label for="data_nascimento">Data de nascimento do locatario:</Label></td>
                    <td><input type="date" id="data_nascimento" name="data_nascimento" value='<c:out value="${locatario.dataNascimento}"/>'></td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" id="logradouro_cep" name="logradouro_cep" maxlength="8" placeholder="00000-000" value='<c:out value="${endereco.lougradouroCep}"/>'></td>
                </tr>

                <tr>
                    <td><Label for="logradouro_cidade">Cidade:</Label></td>
                    <td><input type="text" id="logradouro_cidade" name="logradouro_cidade" maxlength="100" value='<c:out value="${endereco.lougradouroCidade}"/>'></td>
                </tr>
