...
public class ReparoRelatorioController {
	...
	@RequestMapping(name = "cadastrar_reparo_relatorio", value = "/cadastrar_reparo_relatorio", method = RequestMethod.GET)
	public ModelAndView aluguelRelatorioGet() {
		return new ModelAndView("cadastrar_reparo");
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	@RequestMapping(name = "cadastrar_reparo_relatorio", value = "/cadastrar_reparo_relatorio", method = RequestMethod.POST)
	public ResponseEntity aluguelRelatorioPost(@RequestParam Map<String, String> params, ModelMap model) {
		...
		try {
			File arquivo = ResourceUtils.getFile("classpath:reports/CarroReparo.jasper");
